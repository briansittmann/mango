...
- [ ] 8.2 Log in with the test e-mail: request the link on `/login`, open it from the inbox — verify landing on `/dashboard` with the seeded figures (2.820 € / 1.700 € / 146 € / 864 €, accumulated 2.646 €, "comida" 310 of 400, "transporte" 130 of 100, six bars) and the account menu showing the seeded name and phone
