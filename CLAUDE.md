...
- **UI de ahorro** — el panel ya esta estilizado (barra hacia la meta, sparkline, movimientos con signo) via `add-savings-progress`, pero sigue sin `SavingsMutations`: "Añadir movimiento de ahorro" muestra el mensaje de demo.
