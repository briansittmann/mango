...
- **AND** a message says the order could not be saved, and the free margin still reads 974 €
...
- **AND** the expenses total still reads 1.700 €, the free margin 974 €, and each budget bar is at the same level as before
