...
- **AND** the income column shows 2.400 € and the free margin shows 554 €

#### Scenario: Restore brings the entry back
- **WHEN** the same entry is restored
- **THEN** "Freelance" is listed again with 420 € and its date, the income column shows 2.820 € and the free margin shows 974 €
...
- **AND** the income column shows 2.920 € and the free margin 1.074 €
...
- **AND** the income column shows 4.020 € and the free margin 2.174 €
...
- **WHEN** on `/demo` in Spanish, with the free margin at 974 €, the visitor adds an income entry of 300 € described as "Bonus"
- **THEN** the sheet closes and "Bonus" is listed with 300 €
- **AND** the income column shows 3.120 €, the free margin 1.274 €, and "Ingreso añadido" is announced
...
- **AND** "Freelance" is listed again with 420 €, the income column shows 2.820 € and the free margin 974 €
...
- **AND** the income column shows 2.400 € and the free margin 554 €
...
Creating, editing, deleting or restoring an income entry SHALL, in the same render, update the income column's total, the rows of the income panel and the free margin, which SHALL equal income minus expenses minus the cycle's savings.
...
- **AND** the free margin reads 1.274 €, then 1.324 €, then 974 €
...
- **WHEN** the income total is 2 820, the expenses total 1 700 and the cycle's savings 146
- **THEN** the free margin shows 974 €
- **AND** after an income entry of 300 € is added it shows 1.274 €
