...
- Creating a category SHALL NOT change any other category, any expense, the expenses total or the free margin.
...
- **WHEN** on `/demo` in Spanish, with the expenses total at 1.700 € and the free margin at 974 €, the visitor creates "Viajes"
- **THEN** the expenses total still shows 1.700 € and the free margin still shows 974 €
